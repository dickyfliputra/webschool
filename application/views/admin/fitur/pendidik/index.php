<div class="col-lg-12 text-right">
    <a href="<?=site_url('admin/pendidik/add')?>" class="btn btn-success btn-sm mb-3"><i class="fa fa-pencil-alt"></i> Add </a>
</div>
            ...
            <?php 
                ...
                foreach ($row->result() as $key => $data) { ?>
                    <tr>
                        ...
                        <td>
                            <?php 
                                $directory = base_url().'assets/admin/img/pendidik';
                        ...
                        <td>
                            <a href="<?=site_url('admin/pendidik/edit/'.$data->id_staff)?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> </a>
                            ...
                            <script>
                                $(".remove").click(function(){
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            window.location= './pendidik/del/'+id;
                                        }else{
                                            Swal.fire(
                                                'Batal !',
