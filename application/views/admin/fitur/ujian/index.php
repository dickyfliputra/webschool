<div class="col-lg-12 text-right">
    <a href="<?=site_url('admin/ujian/add')?>" class="btn btn-success btn-sm mb-3"><i class="fa fa-pencil-alt"></i> Add </a>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($data->file_jadwal != null){ ?>
                                <a href="<?=base_url().'assets/admin/img/ujian/'.$data->file_jadwal?>"  target="_blank" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> Lihat </a>
                            <?php }else{ ?>
                                <b>None</b>
                            <?php } ?>
                        </td>
                        <td>
                            <a href="<?=site_url('admin/ujian/edit/'.$data->id_jadwal)?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Update </a>
